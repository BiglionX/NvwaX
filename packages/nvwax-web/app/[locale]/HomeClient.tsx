      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-16">
        <div className="w-full max-w-3xl mx-auto text-center animate-[fadeIn_0.8s_ease-out]">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-2xl mx-auto">
            {[
              { value: '240+', label: t('statsAgents'), icon: Bot },
              { value: '5', label: t('statsSources'), icon: Layers },
              { value: '16+', label: t('statsSkills'), icon: Star },
              { value: t('statsProject'), label: t('statsProject'), icon: ({ size, className }: { size?: number; className?: string }) => (
